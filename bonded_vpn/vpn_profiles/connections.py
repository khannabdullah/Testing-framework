...
class Connections_01(Basepage_base):
    ...
    def presist_authentication(self):
        time.sleep(2)
        wait = WebDriverWait(self.driver, 10)
        presist_authentication = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div/div[8]/section/div/div/div[2]/form/div/div[8]/div[27]/div[2]/div/div/div/label[2]')))
    ...
    def site_to_site_server(self, data):
        ...
        Connections_01.profile_name(self, data["profile_name"])
        Connections_01.status(self)
        # Connections_01.status(self)
        Connections_01.routing_list(self, data["routes_list"])
        # Connections_01.performance(self)
        Connections_01.listening_port(self, data["listening_port"])
        Connections_01.tunnel_local_ip(self, data["tunnel_local_ip"])
        Connections_01.tunnel_remote_ip(self, data["tunnel_remote_ip"])
        Connections_01.tunnel_mtu(self, data["tunnel_mtu"])
        Connections_01.encryption(self)
        Connections_01.compression(self)
        Connections_01.tx_queue(self, data["tx_queue"])
        Connections_01.keepalive_timeout(self, data["keepalive_timeout"])
        Connections_01.socket_send_buffer_size(self, data["socket_send_buffer_size"])
        Connections_01.socket_receive_buffer_size(self, data["socket_receive_buffer_size"])
        Connections_01.presist_tunnel_interface(self)
        # Connections_01.presist_authentication(self)
        Connections_01.tunnel_timeout(self, data["tunnel_timeout"])
        Connections_01.suppress_timestamps(self)
        Connections_01.status_version(self)
        Connections_01.form_create(self)

    def site_to_site_client(self, data):
        ...
        Connections_01.routing_list(self, data["routes_list"])
        Connections_01.performance(self)
        Connections_01.remote_server_ip(self, data["remote_server_ip"])
        Connections_01.remote_server_port(self, data["remote_server_port"])
        Connections_01.tunnel_local_ip(self, data["tunnel_local_ip"])
        Connections_01.tunnel_remote_ip(self, data["tunnel_remote_ip"])
        Connections_01.tunnel_mtu(self, data["tunnel_mtu"])
        Connections_01.encryption(self)
        ...
        Connections_01.route_delay(self, data["route_delay"])
        Connections_01.tx_queue(self, data["tx_queue"])
        Connections_01.keepalive_timeout(self, data["keepalive_timeout"])
        Connections_01.socket_send_buffer_size(self, data["socket_send_buffer_size"])
        Connections_01.socket_receive_buffer_size(self,data["socket_receive_buffer_size"])
    ...
    def site_to_multisite_server(self, data):
        ...
        # Connections_01.performance(self)
        Connections_01.listening_port(self,data["listening_port"])
        Connections_01.tunnel_network_subnet(self, data["Tunnel_Network_Subnet"])
        Connections_01.tunnel_mtu(self, data["tunnel_mtu"])
        Connections_01.encryption(self)
        Connections_01.tx_queue(self, data["tx_queue"])
        Connections_01.keepalive_timeout(self,data["keepalive_timeout"])
        Connections_01.presist_tunnel_interface(self)
        # Connections_01.presist_authentication(self)
        Connections_01.syslog(self,data["syslog"])
        Connections_01.suppress_timestamps(self)
        Connections_01.status_version(self)
        Connections_01.form_create(self)

    def site_to_multisite_client(self, data):
